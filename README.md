...
<div align="center"> 
  ...
  <p align="center">
    Al-Tour Al-Dhahabi is a premium theme for Salla Stores specialized in imported meats and premium products. 
    <br />
    <a href="https://salla.dev/"><strong>Explore our blogs »</strong></a>
    <br />
    <a href="https://github.com/ibra2000sd/goldentur/issues/new">Report Bug</a> · 
    <a href="https://github.com/ibra2000sd/goldentur/discussions/new">Request Feature</a> . <a href="https://t.me/salladev">&lt;/Salla Developers&gt;</a> . <a href="https://docs.salla.dev/?nav=01HNFTD5Y5ESFQS3P9MJ0721VM">Official Documentation</a> 
  </p>
</div>
...
## Main Features 
By default, Al-Tour Al-Dhahabi home page displays a collection of Pre-Defined and Custom Components. These components are located in the [`src/views/components/home/`](https://github.com/ibra2000sd/goldentur/tree/master/src/views/components/home) folder.


### Theme Features  
 Pre-Defined  Components, which are know as Theme Features, listed in the [twilight.json](https://github.com/ibra2000sd/goldentur/blob/master/twilight.json) under the `features` section. Below is a list of these components.
...
### Theme Components
The Custom Components can be easily modified by the developer. They are known as Theme Components. Below is the list of the Custom Components that are shipped by default along with Al-Tour Al-Dhahabi.
...
The team is always here to help you. Happen to face an issue? Want to report a bug? You can submit one here on Github using the [Issue Tracker](https://github.com/ibra2000sd/goldentur/issues/new). If you still have any questions, please contact us via the [Telegram Bot](https://t.me/SallaSupportBot) or join in the Global Developer Community on [Telegram](https://t.me/salladev).
